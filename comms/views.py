    ...
    def post(self, request):
        ...
        if recent.exists():
            ...
            return Response({
                ...
                "detail": "Vacancy already created for this [Bit68 -Open Vacancy] email (duplicate ignored).",
        ...
        if not manager:
            ...
            logging.getLogger(__name__).info(f"Created new manager user from [Bit68 -Open Vacancy] email: {manager_email}")
